...
public class MathUtil {
	/**
	 * Restricts a value between a minimum and maximum value. If the value is
	 * greater than the maximum, it is set to maximum; if it is less than the
	 * minimum, it is set to minimum.
	 * 
	...
	/**
	 * Determines whether a given String represents a double.
	 * 
	 * @param s the String to check
	...
	/**
	 * Determines whether a given String represents a boolean.
	 * 
	 * @param s the String to check
